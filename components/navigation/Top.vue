<template>
  <div class="navigation-top z-10">
    <nav :class="classMenu || 'bg-gray-200'">
            ...
            <div v-if="items && items.length > 0" class="hidden md:block">
              <div class="ml-10 flex items-baseline">
                ...
                <NuxtLink
                  ...
                  "
                  :rel="`rel-${index}`"
                  :class="`${`ml-4 px-3 py-2 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white`} btn`"
                >
                  {{ item.slug }}</NuxtLink
                >
              </div>
